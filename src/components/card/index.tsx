...
const Card = ({label, taskCount, color}:any) => {
    return ( 
        <Cards>
            <div className="sm:text-lg text-sm text-gray-500 font-medium">{label}</div>
                <div className="flex-1  flex items-end">
                    <div className="flex flex-1">
                        ...
                        <div className="float-right sm:px-2 px-1 sm:py-2 py-1 flex items-center rounded-md mt-3  h-7" style={{background:'#F2EEFB', color:'#7F56D9'}}>
